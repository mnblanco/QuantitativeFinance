...
data consists of 10 different stocks from the Dow Jones Industrial Average index (see the next table for an overview) for 21 trading days between 06/01/2011 and 06/29/2011. Trading on NYSE and NASDAQ is continuous between 09:30 and 16:00. After aggregating the data into 15-minute time slots, the data frame has 26 observations every day, and a total of 26 * 21 = 546 observations overall.
